...
<div x-cloak :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-white lg:translate-x-0 lg:static lg:inset-0">
    ...
    <nav class="mt-10">
    <a class="flex items-center px-6 py-2 mt-4 {{ Route('admin.dashboard') ? 'text-dark' : 'text-dark' }} hover:bg-blue-500 hover:text-white px-4 rounded-lg" href="{{ route('admin.dashboard') }}">

    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M21 13v10h-6v-6h-6v6h-6v-10h-3l12-12 12 12h-3zm-1-5.907v-5.093h-3v2.093l3 3z"/></svg>
            <span class="mx-3 font-bold">Dashboard</span>
        </a>

    <a class="flex items-center px-6 py-2 mt-4 {{ Route('admin.konser.index') ? 'text-dark' : 'text-dark' }} hover:bg-blue-500 hover:text-white px-4 rounded-lg" href="{{ route('admin.konser.index') }}">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M11 24h-9v-12h9v12zm0-18h-11v4h11v-4zm2 18h9v-12h-9v12zm0-18v4h11v-4h-11zm4.369-6c-2.947 0-4.671 3.477-5.369 5h5.345c3.493 0 3.53-5 .024-5zm-.796 3.621h-2.043c.739-1.121 1.439-1.966 2.342-1.966 1.172 0 1.228 1.966-.299 1.966zm-9.918 1.379h5.345c-.698-1.523-2.422-5-5.369-5-3.506 0-3.469 5 .024 5zm.473-3.345c.903 0 1.603.845 2.342 1.966h-2.043c-1.527 0-1.471-1.966-.299-1.966z"/></svg>
        ...
        <a class="flex items-center px-6 py-2 mt-4 {{ Route::currentRouteNamed('admin.tables') ? 'text-dark' : 'text-dark'  }} hover:bg-blue-500 hover:text-white px-4 rounded-lg" href="{{ route('admin.tables') }}">
        ...
        <a class="flex items-center px-6 py-2 mt-4 {{ Route::currentRouteNamed('admin.ui-elements') ? 'text-dark' : 'text-dark'  }} hover:bg-blue-500 hover:text-white px-4 rounded-lg" href="{{ route('admin.ui-elements') }}">

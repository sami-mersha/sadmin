...
<div x-cloak :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-white lg:translate-x-0 lg:static lg:inset-0">
    ...
    <a class="flex items-center ml-4 mr-4 px-6 py-2 {{ Route::is('admin.konser.index') ? 'bg-blue-500 text-white' : 'text-dark hover:bg-gray-200 hover:text-white' }} px-4 py-4 rounded-lg" href="{{ route('admin.konser.index') }}">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="transition-all duration-300">
    ...
    <a class="flex items-center ml-4 mr-4 px-6 py-2 {{ Route::is('admin.tiket.index') ? 'bg-blue-500 text-white' : 'text-dark hover:bg-gray-200 hover:text-white' }} px-4 py-4 rounded-lg" href="{{ route('admin.tiket.index') }}">
        ...
        <a class="flex items-center ml-4 mr-4 px-6 py-2 {{ Route::is('admin.promo.index') ? 'bg-blue-500 text-white' : 'text-dark hover:bg-gray-200 hover:text-white' }} px-4 py-4 rounded-lg" href="{{ route('admin.promo.index') }}" >
    ...
    <a class="flex items-center ml-4 mr-4 px-6 py-2 {{ Route::is('admin.lokasi.index') ? 'bg-blue-500 text-white' : 'text-dark hover:bg-gray-200 hover:text-white' }} px-4 py-4 rounded-lg" href="{{ route('admin.lokasi.index') }}" >

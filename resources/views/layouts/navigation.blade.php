<style>
    ...
    /* Header Styles */
    #header {
        box-shadow: 0 -3px 6px rgba(0, 0, 0, 0.1), /* Bayangan atas */
                    0 3px 6px rgba(0, 0, 0, 0.1),  /* Bayangan bawah */
                    -3px 0 6px rgba(0, 0, 0, 0.1), /* Bayangan kiri */
                    3px 0 6px rgba(0, 0, 0, 0.1);  /* Bayangan kanan */
            ...
            <div x-data="{ open: false }" class="relative flex items-center gap-4">
                ...
                <div x-data="{ open: false }" class="relative">
                    <button @click="open = !open" class="flex items-center gap-2 text-sm font-medium text-gray-900 focus:outline-none transition-all duration-200 hover:text-blue-600 hover:scale-105 transform">
                        ...
                        Hi, {{ Auth::user()->name }}
                        <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#545454" stroke-width="0.00024000000000000003">

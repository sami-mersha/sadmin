<style>
    ...
    /* Header Styles */
    .hidden-header {
        transform: translateY(-130%); /* Header hilang sepenuhnya */
    ...
    <div class="px-10 mb-2">
        <div class="flex items-center justify-between">
            ...
            <div x-data="{ open: false }" class="relative flex items-center gap-4">
                ...
                <!-- Dropdown Menu -->
                <ul x-show="open" @click.outside="open = false" x-transition class="absolute right-0 z-10 mt-2 w-48 overflow-hidden rounded-lg border border-slate-200 bg-white p-2 shadow-lg">
